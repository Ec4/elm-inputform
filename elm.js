...
var $author$project$Main$init = A3($author$project$Model$Model, 0, 'Hello World!', 'Hello World!');
...
var $author$project$Main$decChar = function (c) {
	return $elm$core$Char$fromCode(
		$elm$core$Char$toCode(c) - 1);
};
var $elm$core$String$foldr = _String_foldr;
var $elm$core$String$toList = function (string) {
	return A3($elm$core$String$foldr, $elm$core$List$cons, _List_Nil, string);
};
var $author$project$Main$decString = function (s) {
	return $elm$core$String$fromList(
		A2(
			$elm$core$List$map,
			$author$project$Main$decChar,
			$elm$core$String$toList(s)));
};
var $author$project$Main$incChar = function (c) {
	return $elm$core$Char$fromCode(
		$elm$core$Char$toCode(c) + 1);
};
var $author$project$Main$incString = function (s) {
	return $elm$core$String$fromList(
		A2(
			$elm$core$List$map,
			$author$project$Main$incChar,
			$elm$core$String$toList(s)));
};
		...
		switch (msg.$) {
			case 'Plus':
				return A3(
					...
					model.n + 1,
					model.i,
					$author$project$Main$incString(model.s));
			case 'Minus':
				return A3(
					$author$project$Model$Model,
					model.n - 1,
					model.i,
					$author$project$Main$decString(model.s));
			case 'Input':
				var str = msg.a;
				return A3($author$project$Model$Model, 0, str, model.s);
			default:
				return A3($author$project$Model$Model, 0, model.i, model.i);
		}
	});
var $author$project$Msg$Immediate = {$: 'Immediate'};
var $author$project$Msg$Input = function (a) {
	return {$: 'Input', a: a};
};
var $author$project$Msg$Minus = {$: 'Minus'};
var $author$project$Msg$Plus = {$: 'Plus'};
...
var $author$project$Style$blue = $rtfeldman$elm_css$Css$hex('66AACC');
...
var $author$project$Style$btn = function () {
	var size = 100;
	return A2(
		...
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Css$px(size * 0.5)),
				...
				$rtfeldman$elm_css$Css$px(size / 4))
			]));
}();
var $rtfeldman$elm_css$Css$color = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'color', c.value);
};
var $author$project$Style$blubtn = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	$author$project$Style$btn,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$blue),
...
var $author$project$Style$ddinp = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Style$dlform = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Style$green = $rtfeldman$elm_css$Css$hex('44AA44');
...
var $author$project$Style$dtlabel = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	$rtfeldman$elm_css$Html$Styled$dt,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$green),
			$rtfeldman$elm_css$Css$color(
			$rtfeldman$elm_css$Css$hex('ffffff')),
			$rtfeldman$elm_css$Css$height(
			$rtfeldman$elm_css$Css$px(40)),
...
var $author$project$Style$inp = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Style$red = $rtfeldman$elm_css$Css$hex('EE6688');
var $author$project$Style$redbtn = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	$author$project$Style$btn,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$red),
			$rtfeldman$elm_css$Css$color(
			$rtfeldman$elm_css$Css$hex('ffffff'))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Msg$Immediate)
					]),
				_List_fromArray(
					[
						A2(
						$author$project$Style$dlform,
						_List_Nil,
						_List_fromArray(
							[
								A2(
								$author$project$Style$dtlabel,
								_List_Nil,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('初期値')
									])),
								A2(
								$author$project$Style$ddinp,
								_List_Nil,
								_List_fromArray(
									[
										A2(
										$author$project$Style$inp,
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Msg$Input),
												$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('初期値を入れてね')
											]),
										_List_Nil)
									]))
							])),
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('初期値として投入')
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'font-size', '36px'),
						A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'margin', '10px')
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(model.s)
					])),
				A2(
				$author$project$Style$blubtn,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Msg$Minus)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('減')
					])),
				A2(
				$author$project$Style$redbtn,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Msg$Plus)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('増')
					]))
			]));
};
